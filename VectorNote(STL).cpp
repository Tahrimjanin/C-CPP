...
int main ()
{
    ...
    v.clear();
    cout << v.size() << endl; /// 0
    cout << v.empty() << endl; /// 1 (boolen function/jehetu khali tai 1 print korse)
    cout << v1.empty() << endl; /// 0

    //vector size change(3ta element thakle jodi resize 5 kora hoe tobe baki duita element hobe 0)
    v1.resize(5);
    cout << v1.size() << endl; /// 5
    ...
    //vector<int> a(5,3); = output come = 3 3 3 3 3
    ...
    vector<int>::iterator it; //vector a iterator is pointer
    for ( it = a.begin(); it != a.end(); it++ ) cout << *it << " "; /// 2 3 4 0 0
    cout << endl;

    a = { 3, 4, 5, 1, 2 };

    sort ( a.begin(), a.end() ); ///O(n*log2(n)) complexcity of sort function 
    ...
    /*
     ...
     for ( auto u : a ) cout << u << " "; ///  3 1 4 5 2 (1 4 5 will be sort)
     */

    sort ( a.rbegin(), a.rend() );//reverse order
    ...
    a = { 3, 4, 5, 1, 2 };
    sort ( a.begin(), a.end(), greater<int>() ); // greater to less
