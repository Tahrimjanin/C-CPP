...
int main ()
{
    ...
    s1= "fghij";
    string s3 = s + s1 ; /// Concatenating two strings
    cout << s3 << endl; /// abcdfghij 

    //push,pop back vector
    s.push_back('a'); 
    cout << s << endl; /// abcdfa
    s.pop_back(); /// removes last char of string
    cout << s << endl; /// abcdf

    cout << *s.begin() << endl; // a(1st char point kora)
    cout << s[s.size()-1] << endl;//last char

    /// String length
    cout << s.length() << endl; /// 6
    cout << s.max_size() << endl; /// Maximum size of a string
    ...
    /// String capacity
    cout << s.capacity() << endl; /// 15 (it may vary)
